...
nPoints = 4 * 24 * 5 # We want to get a point every 15 minutes so 4 * 24 points in a day, over 5 days
...
\end{minted}
\subsection{Elevation, azimuth, distance and doppler shift on the largest window}
\begin{minted}{python}
